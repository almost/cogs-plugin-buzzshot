  ...
  return (
    <div className="fixed inset-0 bg-white flex flex-col">
      ...
      { games.results.length === 0 ? (
          <div className="grow shrink overlow-auto flex items-center justify-center ">
            <div className="text-gray-400 text-xl">No pending groups for today!</div>
          </div>
      ) : (
      <ul className="grow shrink overflow-auto flex flex-col items-stretch gap-1 p-4 min-h-0">
